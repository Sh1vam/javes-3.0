...
@javes.on(admin_cmd(pattern=r"ded"))
...
@javes.on(admin_cmd(pattern=r"monster"))
async def bluedevilmonster(monster):
    await monster.edit(M)
@javes.on(admin_cmd(pattern=r"pig"))
async def bluedevilpig(pig):
    await pig.edit(P)
@javes.on(admin_cmd(pattern=r"kiler"))
async def bluedevilkiller(kiler):
    await kiler.edit(K)
@javes.on(admin_cmd(pattern=r"gun"))
async def bluedevilgun(gun):
    await gun.edit(G)
@javes.on(admin_cmd(pattern=r"dog"))
async def bluedevildog(dog):
    await dog.edit(D)    
@javes.on(admin_cmd(pattern=r"hello"))
async def bluedevilhello(hello):
    await hello.edit(H)
@javes.on(admin_cmd(pattern=r"hmf"))
