...
from ub.events import admin_cmd, command
import io
import heroku3
...
from ub import CMD_HELP, LOGS, HEROKU_APPNAME, HEROKU_APIKEY
import sys
import json
from ub import BOTLOG, BOTLOG_CHATID, CMD_HELP, bot, UPSTREAM_REPO_URL
...
from ub import LOGS, CMD_HELP, TEMP_DOWNLOAD_DIRECTORY
import sys
try:
...
from ub import CMD_HELP, LOGS, HEROKU_APP_NAME, HEROKU_API_KEY
...
from ub import CMD_HELP, ALIVE_NAME
...
import requests
import math
from ub.javes_main.commands import progress, humanbytes, time_formatter
...
from ub.events import javes05
from ub.prettyjson import prettyjson
