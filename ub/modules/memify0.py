...
miraculous_ladybug = "ub/helpers/styles/"
MARGINS = [50, 150, 250, 350, 450]
CNG_FONTS = "ub/helpers/styles/impact.ttf"
...
async def memes(cat):
    ...
    if catsticker.endswith(".tgs"):
        ...
        os.system(f"lottie_convert.py --frame 0 -if lottie -of png {catsticker} ./temp/temp.jpg")
...
async def lang(event):
    ...
    if not input_str:
        ...
        await event.edit("use !term ls ub/helpers/styles")
    if input_str not in font_list:
        ...
        arg = f"ub/helpers/styles/{input_str}"
        CNG_FONTS = arg
