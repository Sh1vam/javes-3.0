...
#modified to get translations in any language 
import asyncio
import os
...
@javes.on(admin_cmd("trlte"))
async def webss(message):
    shiva= message.text
    shivam=shiva[7:]
    langcode,text=shivam.split(";")

    link = f"https://translate.google.com/?sl=auto&tl={langcode}&text={text}&op=translate"
