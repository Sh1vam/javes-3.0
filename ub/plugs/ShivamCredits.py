...
Add them to your harem by sending /protecc character name""" 
        ...
        if re.search(pattern, name, flags=re.IGNORECASE):
            try:
                      ...
                      #Made by Shivam#Made by Shivam#Made by Shivam#Made by Shivam#Made by Shivam#Made by Shivam#Made by Shivam
                      try:
                            from ub.plugs.sqls.autowafu_sql import get_current_wafu_settings
                            from ub.plugs.sqls.autowafu_sql import update_previous_wafu
...
async def save_wafu(event):
    try:
        from ub.plugs.sqls.autowafu_sql import add_wafu_setting
    except AttributeError:
...
async def del_wafu(event):
    try:
        from ub.plugs.sqls.autowafu_sql import rm_wafu_setting
    except AttributeError:
        await event.edit("`Running on Non-SQL mode!`")
        return
